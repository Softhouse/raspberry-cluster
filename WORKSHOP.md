...
This section contains workshop instructions for attendees.

A prerequisite is that the clusters have been initialized using the ansible playbooks, hostnames have been consistently set up and ip-addresses are static.
